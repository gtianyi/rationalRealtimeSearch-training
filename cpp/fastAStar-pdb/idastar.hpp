...
class Idastar : public SearchAlg<D> {
    ...
    double bucketInterval = 1;// for heavy
	//double bucketInterval = 0.01 ; //for inverse
    //double hugeCost = 1000; //for inverse
    double hugeCost = 1000000; // for heavy
