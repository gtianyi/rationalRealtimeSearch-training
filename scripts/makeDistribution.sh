...
g++ -g -std=c++11 -static ../cpp/collect-inverse-post-search.cpp -o ../../build_release/collect-inverse-post-search
...
chmod a+x ../../build_release/collect-inverse-post-search
